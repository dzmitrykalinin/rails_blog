class Admin::PostsController < Admin::ApplicationController
  ...
  def create
    ...
    if @post.save
      redirect_to admin_posts_url, notice: 'Post was successfulley created'
    else
  ...
  def update
    ...
    if @post.update(post_params)
      ...
      flash[:alert] = 'There was a problem updateding post'
      render :edit
    end
  end
  ...
  def post_params
    params.require(:post).permit(:id, :title, :content, :published, tag_ids: [])
  end
end
